...
//                     <span role="img"> 😎 </span> Born in Kinshasa (Congo), I am passionate about Technologies (not only the Web that I do); I've been working for 5 years (since 2016) as a Graphic Designer (Freelance, Logo Designer), and started learning Web Technologies (from 2017 to this point); In 2020, I started doing Freelance...<br/><br/>
