    ...
    return (
        <div className="min-h-screen">
            ...
            <Layout>
                ...
                <div className="my-5">
                    <span className="text-xl"> 🔔 </span> <span className=" font-semibold font-sans text-white"> New Projects are being pulled in the days to come... Stay tuned ! </span> <span className="text-xl">😍</span> <br/>   
                </div>
                ...
                <div className="mt-7 mb-3 md:mt-12 flex flex-row justify-center md:my-10 md:mb-12 invisible md:visible">
                    <Link to="/hire">
                        <button className="flex flex-row justify-items-center text-mirage-500 bg-white md:mt-6 rounded p-1">
                            <h1 className="text-xl my-1 ml-2 font-sans font-semibold">
                                Hire me
                            </h1>
